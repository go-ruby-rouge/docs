...
The public API lives at the module root (`github.com/go-ruby-rouge/rouge`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rouge`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-rouge/rouge](https://pkg.go.dev/github.com/go-ruby-rouge/rouge)**

The module's [README](https://github.com/go-ruby-rouge/rouge#readme) carries worked
