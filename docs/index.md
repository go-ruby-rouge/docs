# go-ruby-rouge documentation

**Pure-Go, MRI-faithful Ruby rouge (no cgo)**

`go-ruby-rouge/rouge` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rouge`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rouge`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-rouge/rouge
```
...
| Repo | What it is |
| --- | --- |
| [`rouge`](https://github.com/go-ruby-rouge/rouge) | the library — Ruby's `rouge` in pure Go |
| [`docs`](https://github.com/go-ruby-rouge/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rouge.github.io`](https://github.com/go-ruby-rouge/go-ruby-rouge.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rouge/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rouge/rouge](https://github.com/go-ruby-rouge/rouge).
