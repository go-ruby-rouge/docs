...
Contributions are welcome. `go-ruby-rouge/rouge` is built to a small set of
...
The library is in [`github.com/go-ruby-rouge/rouge`](https://github.com/go-ruby-rouge/rouge).
This documentation site is in [`github.com/go-ruby-rouge/docs`](https://github.com/go-ruby-rouge/docs).
